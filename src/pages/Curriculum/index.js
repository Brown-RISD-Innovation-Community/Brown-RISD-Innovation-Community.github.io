          ...
          <div style={{ width: "600px" }}>
            ...
            <Row style={{ textAlign: "left" }} className="mb-4">
              ...
              >
                ...
                <li>
                  Creates a platform for students across Brown and RISD to meet
                  and collaborate in a low-pressure environment
                </li>
              </ul>
            </Row>
        ...
        <Row className="mt-0 pb-5 d-flex align-items-center">
          ...
          >
            ...
            >
              ...
              member. <strong>Each week has a theme</strong> (eg. Graphic
              Design, Data Analysis) and there will be{" "}
              <strong>
                two workshops related to that theme on different days of the
                week
              </strong>
              . Both the workshops will cover complimentary topics, but won't
              rely on each other. For example, in the Graphic Design week, there
              will be two workshops: <strong>UI/UX Design</strong> and{" "}
        ...
        <Row className="mt-0 pb-5 d-flex align-items-center">
          ...
          >
            ...
            >
              ...
              . People who don’t attend workshops can still participate in
              design challenges.
            </p>
          </Col>
          <Col xs={4} className="d-flex justify-content-center">
        ...
        <Row className="mt-0 pb-5 d-flex align-items-center">
          ...
          >
            ...
            >
              ...
              We want to move away from only product and service based
              conceptions of innovation. Here, BRIC will act as a platform for
              students to collaborate and create across College Hill!
            </p>
          </Col>
        </Row>
        <br />
        ...
        <Row className="mt-0 pb-5 d-flex align-items-center">
          ...
          >
            ...
            >
              ...
              <strong>
                Mentors will be paired with upto 2 student groups based on
                shared interests and experience, and will guide them in project
